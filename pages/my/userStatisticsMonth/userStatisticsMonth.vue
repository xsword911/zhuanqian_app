...
<!-- 			<view class="lay_box" v-if="isOpenGold == 1">
				<view class="style_Numtest">{{StatisticsMonthEn.money2Gold}}</view>
				<view class="">现金转金币</view>
			</view>
			
			<view class="lay_box" v-if="isOpenGold == 1">
				<view class="style_Numtest">{{StatisticsMonthEn.gold2Money}}</view>
				<view class="">金币转现金</view>
			</view>
...
<!-- 				<view class="" v-show="isOpenGold == 1">
...
export default{
	...
	methods:{
		...
		getStatisticsMonth(uid){
			...
			api.getStatisticsMonth(data, (res)=>{
